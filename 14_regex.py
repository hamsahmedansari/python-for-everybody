...
# Actual data: http://py4e-data.dr-chuck.net/regex_sum_2421827.txt (There are 68 values and the sum ends with 213)
...
def main():
    numbers = find_numbers('data/regex_sum_2421827.txt')
    print(numbers)
